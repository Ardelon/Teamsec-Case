...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "apps.core.authentication.SessionOperatorAuthentication",
        "apps.core.authentication.BearerJWTAuthentication",
    ],
...
SESSION_COOKIE_AGE = int(os.environ.get("JWT_EXPIRY_HOURS", "8")) * 3600
